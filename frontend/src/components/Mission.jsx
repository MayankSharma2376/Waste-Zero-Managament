      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="mb-8">
          ...
          <h2 className={`text-4xl md:text-5xl font-extrabold mb-6 ${
            ...
            Our <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">Mission</span>
          </h2>
          <p className={`text-lg leading-relaxed mb-8 ${
            isDarkMode ? 'text-gray-300' : 'text-gray-700'
          }`}>
            To build a sustainable future by providing innovative and accessible recycling solutions. 
            We are dedicated to educating communities, empowering individuals, and preserving our 
            planet for generations to come through responsible waste management.
          </p>
        </div>
        ...
        {/* CTA Button */}
        <div className="mt-10">
          <button className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-green-600 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 hover:shadow-xl hover:scale-105">
            Learn More About Us

...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    connect: [
      { name: 'Schedule Pickup', href: '#pickup' },
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="relative">
                ...
                <FaLeaf className="absolute -top-1 -right-1 text-sm text-green-300" />
              </div>
              <div>
                <h3 className="text-2xl font-bold">
                  Waste<span className="text-emerald-400">Zero</span>
                </h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-emerald-200/90">
                ...
                <span className="text-sm">info@wastezero.com</span>
              </div>
              <div className="flex items-center gap-3 text-emerald-200/90">
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 bg-white/10 hover:bg-gradient-to-br hover:from-emerald-500 hover:to-green-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                    >
        ...
        <div className="border-t border-white/10 pt-10 pb-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-emerald-200/80 mb-6">
              Subscribe to our newsletter for eco-tips, updates, and exclusive offers
            </p>
